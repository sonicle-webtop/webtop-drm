 ...
 */
Ext.define('Sonicle.webtop.drm.view.DocStatus', {
	extend: 'WTA.sdk.ModelView',
	requires: [
		'Sonicle.webtop.drm.model.DocStatus',
		'Sonicle.webtop.drm.ux.GroupGrid'
	],
	dockableConfig: {
		title: '{docStatus.tit}', //localizzato
		iconCls: 'wtdrm-icon-docStatus-xs',
		width: 500,
		height: 500
	},
	fieldTitle: 'name',
	modelName: 'Sonicle.webtop.drm.model.DocStatus',
			...
			items: [
				{
					...
					items: [{
							xtype: 'textfield',
							bind: '{record.name}',
							fieldLabel: me.mys.res('docStatus.fld-name.lbl')
						}, {
							xtype: 'textfield',
							bind: '{record.description}',
							fieldLabel: me.mys.res('docStatus.fld-description.lbl')
						}, WTF.lookupCombo('id', 'desc', {
							bind: '{record.type}',
							store: Ext.create('Sonicle.webtop.drm.store.StatusType', {
								autoLoad: true
							}),
							fieldLabel: me.mys.res('docStatus.fld-type.lbl'),
							width: 250
						})
					]
				},

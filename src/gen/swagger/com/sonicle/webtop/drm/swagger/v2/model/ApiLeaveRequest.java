...
public class ApiLeaveRequest   {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(leaveRequestId, domainId, companyId, userId, user, managerId, manager, type, fromDate, toDate, fromHour, toHour, status, result, employeeCancReq);
  }

 ...
 */
Ext.define('Sonicle.webtop.drm.ux.ActivityGrid', {
	extend: 'Ext.grid.Panel',
	alias: 'widget.wtdrmactivitygrid', 
	requires: [
		'Sonicle.picker.List',
		'WTA.ux.PickerWindow',
	...
	initComponent: function () {
		...
		if (!me.viewConfig) {
			me.viewConfig = {
				...
				emptyText: WT.res(me.sid, 'groupactivity.emp')
			};
		}
	...
	createPicker: function () {
		...
		return Ext.create({
			...
			title: WT.res(me.sid, 'groupactivity.picker.tit'),
			height: 350,
			items: [{
					xtype: 'solistpicker',
					store: me.lookupStore,

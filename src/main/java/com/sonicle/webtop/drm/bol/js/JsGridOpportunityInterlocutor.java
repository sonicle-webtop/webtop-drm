 ...
 * @author lssndrvs
 */
public class JsGridOpportunityInterlocutor {
	...
	public static OpportunityInterlocutor createOpportunityInterlocutor(JsGridOpportunityInterlocutor js) {
		...
		OpportunityInterlocutor oI = new OpportunityInterlocutor();
		oI.setId(js.id);
		oI.setOpportunityId(js.opportunityId);
		oI.setContactId(js.contactId);

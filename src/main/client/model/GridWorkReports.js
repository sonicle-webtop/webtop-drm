...
Ext.define('Sonicle.webtop.drm.model.GridWorkReports', {
	...
	fields: [
		...
		WTF.roField('companyDescription', 'string'),
		WTF.roField('operatorId', 'string'),
		WTF.roField('operatorDescription', 'string'),
		...
		WTF.roField('docStatusId', 'int'),
		WTF.roField('docStatusDescription', 'string'),
		WTF.roField('fromDate', 'date', {dateFormat: 'Y-m-d'}),
		WTF.roField('toDate', 'date', {dateFormat: 'Y-m-d'}),
		WTF.roField('year', 'int'),
		WTF.roField('referenceNo', 'string'),
		WTF.roField('causalId', 'int'),
		WTF.roField('causalDescription', 'string'),
		WTF.roField('chargeTo', 'bool'),
		WTF.roField('businessTripId', 'int'),
		WTF.roField('businessTripDescription', 'string'),

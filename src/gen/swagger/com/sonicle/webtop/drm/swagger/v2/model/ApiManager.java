...
public class ApiManager   {
  ...
  /**
   **/
  public ApiManager id(String id) {
    this.id = id;
    return this;
  }
  ...
  /**
   **/
  public ApiManager displayname(String displayname) {
  ...
  public boolean equals(Object o) {
    ...
    ApiManager manager = (ApiManager) o;
    return Objects.equals(this.id, manager.id) &&
        Objects.equals(this.displayname, manager.displayname);
  }

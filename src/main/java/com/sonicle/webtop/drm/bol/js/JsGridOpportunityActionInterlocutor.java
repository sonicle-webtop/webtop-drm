 ...
 * @author lssndrvs
 */
public class JsGridOpportunityActionInterlocutor {
	...
	public static OpportunityActionInterlocutor createOpportunityActionInterlocutor(JsGridOpportunityActionInterlocutor js) {
		...
		OpportunityActionInterlocutor oAI = new OpportunityActionInterlocutor();
		oAI.setId(js.id);
		oAI.setOpportunityActionId(js.opportunityActionId);
		oAI.setContactId(js.contactId);

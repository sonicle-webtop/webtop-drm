 ...
 * @author dnllr
 */
public class JsGridTicketCategory {
	...
	public JsGridTicketCategory(TicketCategory category) {
		this.ticketCategoryId = category.getTicketCategoryId();
		this.domainId = category.getDomainId();

...
Ext.define('Sonicle.webtop.drm.ux.UserGrid', {
	...
	requires: [
		...
		'Sonicle.webtop.drm.model.DrmUserLkp'
	],
	...
	initComponent: function () {
		...
		me.lookupStore = Ext.create('Ext.data.Store', {
			autoLoad: true,
			model: 'Sonicle.webtop.drm.model.DrmUserLkp',
			proxy: WTF.proxy(me.sid, 'LookupUsers', 'data')
		});
		...
		if (!me.viewConfig) {
			me.viewConfig = {
				...
				emptyText: WT.res(me.sid, 'groupusers.emp')
			};
		}
	...
	createPicker: function () {
		...
		return Ext.create({
			...
			title: WT.res(me.sid, 'groupusers.picker.tit'),
			height: 350,
			items: [{
					xtype: 'solistpicker',
					store: me.lookupStore,
